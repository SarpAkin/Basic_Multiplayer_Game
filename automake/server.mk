...
_.._src_server_server.cpp.o:../src/server/server.cpp ../src/server/../shared/Tsafe_queue.h ../src/server/../shared/message.h ../src/server/server.h ../src/server/../shared/connection.h
	$(CC) -c ../src/server/server.cpp -o_.._src_server_server.cpp.o $(CFLAGS)
_.._src_server_main.cpp.o:../src/server/main.cpp ../src/server/../shared/Tsafe_queue.h ../src/server/../shared/message.h ../src/server/server.h ../src/server/../shared/connection.h
