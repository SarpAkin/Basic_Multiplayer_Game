...
_.._src_client_client.cpp.o:../src/client/client.cpp ../src/client/../shared/welcomeMessage.h ../src/client/../shared/Tsafe_queue.h ../src/client/client.h ../src/client/../shared/message.h ../src/client/../shared/connection.h
	$(CC) -c ../src/client/client.cpp -o_.._src_client_client.cpp.o $(CFLAGS)
_.._src_client_c_game.cpp.o:../src/client/c_game.cpp ../src/client/../shared/entity.h ../src/client/renderer.h ../src/client/../shared/game.h ../src/client/client.h ../src/client/../shared/message.h ../src/client/../shared/message_types.h ../src/client/../shared/vector2.h ../src/client/../shared/Tsafe_queue.h ../src/client/c_game.h ../src/client/../shared/connection.h ../src/client/../shared/EntityCompenents/compenent.h
	$(CC) -c ../src/client/c_game.cpp -o_.._src_client_c_game.cpp.o $(CFLAGS)
_.._src_client_main.cpp.o:../src/client/main.cpp ../src/client/renderer.h ../src/client/../shared/game.h ../src/client/client.h ../src/client/../shared/entity.h ../src/client/../shared/message.h ../src/client/../shared/message_types.h ../src/client/../shared/vector2.h ../src/client/../shared/Tsafe_queue.h ../src/client/c_game.h ../src/client/../shared/connection.h ../src/client/../shared/EntityCompenents/compenent.h
